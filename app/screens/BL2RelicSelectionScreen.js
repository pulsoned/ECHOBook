...
import { bl2Relics } from "../assets/BL2/bl2relics";
...
export default function BL2RelicSelectionScreen(props) {
  return (
    <ImageBackground
      ...
      <View style={styles.scroll}>
        ...
        <ScrollView stickyHeaderIndices={[0]}>
          ...
          <View style={styles.headingview}>
            <Text style={styles.headingtext}>Relic List</Text>
          ...
          {bl2Relics.map((item) => (
            ...
            <TouchableHighlight
              key={item.key}
              style={styles.button}
              onPress={() => props.navigation.navigate("BL2RelicInfo", item)}
            >
              <View style={styles.buttonView}>
                ...
                <View style={styles.descriptionview}>
                  <Text style={styles.descriptionhelper}>Relic Type</Text>
                  <Text style={styles.descriptiontext}>{item.relic_type}</Text>
