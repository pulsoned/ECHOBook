...
export default function BL3ArtifactInfoScreen({ route, navigation }) {
  ...
  return (
    ...
    >
      ...
      <ScrollView style={styles.scroll} stickyHeaderIndices={[0]}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("BL3Artifacts")}
        ...
        <View style={styles.infoView1}>
          ...
          <View style={styles.textBorder}>
            <Text style={styles.info1Text}>Artifact Type</Text>
            <Text style={styles.info1Info}>{item.artifact_type}</Text>
          </View>
          <View style={styles.textBorder}>
