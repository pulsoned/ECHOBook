...
import { bl2Weapons } from "../assets/BL2/bl2weapons";
...
export default function BL2WeaponSelectionScreen(props) {
  return (
    <ImageBackground
        ...
        <ScrollView stickyHeaderIndices={[0]}>
          ...
          {bl2Weapons.map((item) => (
            ...
            <TouchableHighlight
              key={item.key}
              style={styles.button}
              onPress={() => props.navigation.navigate("BL2WeaponInfo", item)}
            >
