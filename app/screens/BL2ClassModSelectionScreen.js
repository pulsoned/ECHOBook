...
import { bl2ClassMods } from "../assets/BL2/bl2classmods";
...
export default function BL2ClassModSelectionScreen(props) {
  return (
    <ImageBackground
