...
import { bl3Weapons } from "../assets/BL3/bl3weapons";
...
export default function BL3WeaponSelectionScreen(props) {
  return (
    <ImageBackground
        ...
        <ScrollView stickyHeaderIndices={[0]}>
          ...
          {bl3Weapons.map((item) => (
            ...
            <TouchableHighlight
              key={item.key}
              style={styles.button}
              onPress={() => props.navigation.navigate("BL3WeaponInfo", item)}
            >
