...
import { bl3Artifacts } from "../assets/BL3/bl3artifacts";
...
export default function BL3ArtifactSelectionScreen(props) {
  return (
    <ImageBackground
      ...
      <View style={styles.scroll}>
        ...
        <ScrollView stickyHeaderIndices={[0]}>
          ...
          <View style={styles.headingview}>
            <Text style={styles.headingtext}>Artifacts List</Text>
            ...
            >
              <View style={styles.buttonView}>
                ...
                <View style={styles.descriptionview}>
                  <Text style={styles.descriptionhelper}>Artifact Type</Text>
