...
export default function BLTPSOzKitInfoScreen({ route, navigation }) {
  ...
  return (
    ...
    >
      ...
      <ScrollView style={styles.scroll} stickyHeaderIndices={[0]}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("BLTPSOzKits")}
        ...
        <View style={styles.infoView1}>
          ...
          <View style={styles.textBorder}>
            <Text style={styles.info1Text}>Oz Kit Type</Text>
            <Text style={styles.info1Info}>{item.ozkit_type}</Text>
          </View>
          <View style={styles.textBorder}>
