...
import { bltpsShields } from "../assets/BLTPS/bltpsshields";
...
export default function BLTPSShieldSelectionScreen(props) {
  return (
    <ImageBackground
