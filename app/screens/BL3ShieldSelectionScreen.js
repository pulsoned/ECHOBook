...
import { bl3Shields } from "../assets/BL3/bl3shields";
...
export default function BL3ShieldSelectionScreen(props) {
  return (
    <ImageBackground
        ...
        <ScrollView stickyHeaderIndices={[0]}>
          ...
          {bl3Shields.map((item) => (
            ...
            <TouchableHighlight
              key={item.key}
              style={styles.button}
              onPress={() => props.navigation.navigate("BL3ShieldInfo", item)}
            >
