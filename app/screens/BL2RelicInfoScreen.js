...
export default function BL2RelicInfoScreen({ route, navigation }) {
  ...
  return (
    ...
    >
      ...
      <ScrollView style={styles.scroll} stickyHeaderIndices={[0]}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("BL2Relics")}
        ...
        <View style={styles.infoView1}>
          ...
          <View style={styles.textBorder}>
            <Text style={styles.info1Text}>Relic Type</Text>
            <Text style={styles.info1Info}>{item.relic_type}</Text>
          </View>
          <View style={styles.textBorder}>
